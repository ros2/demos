...
def generate_test_description():
    ...
    processes_under_test = [
        ExecuteProcess(
            ...
            output='screen',
            env=env)
        for i, executable in enumerate('/home/deepanshu/deepanshu/osrf/ros2_rolling/src/ros2/demos/demo_nodes_cpp/cmake-build-debug/add_two_ints_server;/home/deepanshu/deepanshu/osrf/ros2_rolling/src/ros2/demos/demo_nodes_cpp/cmake-build-debug/add_two_ints_client_async'.split(';'))
    ]
...
class TestExecutablesTutorial(unittest.TestCase):
    ...
    def test_processes_output(self, proc_output, processes_under_test):
        ...
        output_files = '/home/deepanshu/deepanshu/osrf/ros2_rolling/src/ros2/demos/demo_nodes_cpp/test/add_two_ints_server;/home/deepanshu/deepanshu/osrf/ros2_rolling/src/ros2/demos/demo_nodes_cpp/test/add_two_ints_client_async'.split(';')
