...
#define NODE_MAIN_LOGGER_NAME "post_set_parameters_callback"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<demo_nodes_cpp::PostSetParameterCallback>";
