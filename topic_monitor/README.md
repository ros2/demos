...
1. Run the `ros2 launch topic_monitor launch_reliability_demo.launch.py` executable on the stationary machine.
...
1. Run the `ros2 launch topic_monitor launch_depth_demo.launch.py` executable on the stationary machine.
...
1. Run the `ros2 launch topic_monitor launch_fragmentation_demo.launch.py` executable on the stationary machine.
