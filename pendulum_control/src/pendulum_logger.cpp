...
{
class PendulumLogger : public rclcpp::Node
{
public:
  explicit PendulumLogger(const rclcpp::NodeOptions & options)
  : Node("pendulum_logger", options)
  {
    ...
    .best_effort();
    auto subscription = this->create_subscription<pendulum_msgs::msg::RttestResults>(
...
RCLCPP_COMPONENTS_REGISTER_NODE(pendulum_control::PendulumLogger)
